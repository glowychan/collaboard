    ...
    return (
      <div ref={this.setWrapperRef} className='share-pop'>
        <div className='url-share'>
          ...
          <input className='share-url' id='share' type='text' defaultValue={URL} readOnly />
        </div>
        <div className='social-share'>
          ...
          <EmailShareButton subject="Let's collaborate! Join my Twoodle Board" body={"Lets visualize our ideas. Check out my latest Twoodle Board here: " + URL}>
